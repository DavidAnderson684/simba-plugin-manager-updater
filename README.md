...
2. Change the 1 to be the user ID of the user on your WordPress plugin-distributing site who is hosting this plugin (i.e. the user ID loggin into Simba Plugin Manager to provide updates of this plugin).
